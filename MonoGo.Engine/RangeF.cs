...
namespace MonoGo.Engine
{
    ...
    {
        internal class RangeFConverter : JsonConverter<RangeF>
        {
            ...
            public override RangeF Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                return Parse(reader.GetString()!);
            }

            public override void Write(Utf8JsonWriter writer, RangeF value, JsonSerializerOptions options)
            {
